			...
			if(jQuery().bootstrapWizard){
				...
				r.validate({
					...
					errorPlacement:function(e,r){
						"c_gender"==r.attr("name")?e.insertAfter("#form_gender_error"):e.insertAfter(r)
					},
					...
					success:function(e){
						"c_gender"==e.attr("for")?(e.closest(".form-group").removeClass("has-error").addClass("has-success"),
								e.remove()):
