var Login=function(){
	var e=function(){$(".login-form").validate({
		errorElement:"span",
	...
	$(".login-form input").keypress(function(e){
		return 13==e.which?(
				$(".login-form").validate().form()&&$(".login-form").submit(),!1):void 0
	})},
		i=function(){
			function e(e){
				if(!e.id)
			...
			jQuery().select2&&$("#country_list").size()>0&&($("#country_list").select2(
					...
					$(".register-form").validate({
						...
						errorPlacement:function(e,r){
							"tnc"==r.attr("name")?e.insertAfter($("#register_tnc_error")):1===r.closest(".input-icon").size()?e.insertAfter(
									r.closest(".input-icon")):e.insertAfter(r)
						},
						submitHandler:function(e){
							e[0].submit()
						}}),
