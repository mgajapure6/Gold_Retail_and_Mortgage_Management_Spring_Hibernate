			...
			if(jQuery().bootstrapWizard){
				...
				r.validate({
					...
					errorPlacement:function(e,r){
						"supplier_gender"==r.attr("name")?e.insertAfter("#form_gender_error"):e.insertAfter(r)
					},
					...
					success:function(e){
						"supplier_gender"==e.attr("for")?(e.closest(".form-group").removeClass("has-error").addClass("has-success"),
								e.remove()):
